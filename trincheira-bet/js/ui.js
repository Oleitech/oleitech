const UI = {
  ...
  renderTipCard({ home, away, homeLogo, awayLogo, league, time, marketKey, marketLabel, pick, odds, score, factors, learningFactors, stake, tese, sources, sport }) {
    const MARKET_COLORS = {
      btts: 'var(--m-btts)', over25: 'var(--m-over)', over15: 'var(--m-over)', cards: 'var(--m-cards)',
    ...
    const MARKET_LABELS = {
      btts: 'Ambas marcam', over25: 'Mais/menos 2.5 golos', over15: 'Mais/menos 1.5 golos', cards: 'Cartões',
